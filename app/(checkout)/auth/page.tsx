...
const AuthPage = () => {
  return (
    <div className="flex-auto container flex items-center justify-center">
      <div className="grid grid-cols-1 sm:grid-cols-2 w-full max-w-4xl border rounded-lg">
        <div className="flex flex-col justify-center items-center gap-3 border-b sm:border-b-0 sm:border-r p-8">
